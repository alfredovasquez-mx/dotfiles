...
const vec4 TRAIL_COLOR = vec4(0.545, 0.663, 0.659, 0.34);        // Muted aqua for Kanagawa Dragon
const vec4 TRAIL_COLOR_ACCENT = vec4(0.714, 0.565, 0.463, 0.22); // Soft warm accent
const vec4 CURRENT_CURSOR_COLOR = TRAIL_COLOR;
const vec4 PREVIOUS_CURSOR_COLOR = TRAIL_COLOR;
const float DURATION = .14;
const float OPACITY = .2;
// Don't draw trail within that distance * cursor size.
// This prevents trails from appearing when typing.
const float DRAW_THRESHOLD = 1.9;
